...
<head>
    ...
    <!--SEO TAGS -->
    <title>#${hashtag} – Trending on Drama Spots</title>
    <meta name="title" content="#${hashtag} – Trending on Drama Spots">
    <meta name="description"
        content="Discover the latest trending stories and gossip tagged with #${hashtag} on Drama Spots. Stay updated with exclusive content.">
    ...
    <meta property="og:image:alt" content="#${hashtag} – Trending on Drama Spots">
    <meta property="og:image:type" content="image/jpeg">
    <meta property="og:url" content="href="https://dramaspots.com/hashtag/${hashtag}">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@dramaSpot254">
    <meta name="twitter:title" content="#${hashtag} – Trending on Drama Spots">
...
// You should implement this API endpoint to return more posts as JSON
                const res = await fetch(\`/hashtag/articles/all/latest/\${hashTag}?page=\${latestPage}\`);
