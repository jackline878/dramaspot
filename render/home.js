...
<head>
    ...
    <!--SEO TAGS -->
    <title>DramaSpots - Celebrity News, Music, Movies, Entertainment Gossip & Updates</title>
    <meta name="title" content="DramaSpots - Celebrity News, Music, Movies, Entertainment Gossip & Updates">
    <meta name="description"
        content="Stay updated with the latest celebrity news, trending music, blockbuster movies, and exclusive entertainment gossip. Discover it all on Drama Spots, your go-to source for real-time updates and inside scoops.">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Dramaspots">
    <meta property="og:title" content="DramaSpots - Celebrity News, Music, Movies, Entertainment Gossip & Updates">
    ...
    <meta property="og:image:alt" content="DramaSpots - Celebrity News, Music, Movies, Entertainment Gossip & Updates">
    <meta property="og:image:type" content="image/jpeg">
    <meta property="og:url" content="https://dramaspots.com">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@dramaSpot254">
    <meta name="twitter:title" content="DramaSpots - Celebrity News, Music, Movies, Entertainment Gossip & Updates">
...
<button id="installApp" class="btn btn-pink shadow rounded-pill px-4 py-2 position-fixed bottom-0 start-0 m-3 text-light" style="display: none; z-index: 9999;">
  📲 Install DramaSpots
</button>
...
<div class="mt-1 mx-3 search-bar collapse search-bar-collapse"" id="seachBar">
    ...
    <section class=" mt-3">
    <div class="ms-2">
        <h1 class="hero-title">News and Updates</h1>
        <p class="hero-subtitl">Get the latest gossip, trending scandals, and viral entertainment news from everywhere</p>
    </div>
</section>
    <main>
...
${data.featured && data.featured.length ? `
            ...
            <section class="featured-section">
                ...
                <div class="featured-grid${data.featured.length}">
                    <article class="featured-main">
<picture>
  <source srcset="/image/convert?url=${data.featured[0].image}&format=avif" type="image/avif">
  <source srcset="/image/convert?url=${data.featured[0].image}&format=webp" type="image/webp">
  <img src="${data.featured[0].image}" alt="Featured Image">
</picture>
...
<picture>
  <source srcset="/image/convert?url=${data.featured[1].image}&format=avif" type="image/avif">
  <source srcset="/image/convert?url=${data.featured[1].image}&format=webp" type="image/webp">
  <img src="${data.featured[1].image}" alt="Featured Image">
</picture>
                ...
                new Map(
                 ...
                 ${data.featured && data.featured[2] ? `
                    <div class="featured-side">
                        <article class="featured-side-article">
<picture>
  <source srcset="/image/convert?url=${data.featured[2].image}&format=avif" type="image/avif">
  <source srcset="/image/convert?url=${data.featured[2].image}&format=webp" type="image/webp">
  <img src="${data.featured[2].image}" alt="Featured Image">
</picture>
...
<script>
    ...
    <section class="categories-section" id="categories-section">
        ...
        <div class="category-row">
                    ...
                    ${cat.articles.map((post, index) => {
                return `
        <a href="/article/${post.slug}"><div class="cat-post">
                                                <picture>
  <source srcset="/image/convert?url=${post.image}&format=avif" type="image/avif">
  <source srcset="/image/convert?url=${post.image}&format=webp" type="image/webp">
